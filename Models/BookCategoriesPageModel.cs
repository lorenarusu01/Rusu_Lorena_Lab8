...
namespace Rusu_Lorena_Lab8.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Rusu_Lorena_Lab8Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Rusu_Lorena_Lab8Context context,
